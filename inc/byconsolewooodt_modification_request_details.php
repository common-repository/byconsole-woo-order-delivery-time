...
function byconsolewooodt_custom_modification_request_form(){
	...
	if(isset($_REQUEST['byconsolewooodt_new_customer_details_send'])){
		...
		if(wp_mail( $to, 'This mail for a new customization request.', $message, $headers )){
			...
			echo '<p class="success_mail_send">'.esc_html( __('We will get back to you soon regarding your request. Alternatively you can query about your request by emailing to support@byconsole.com/developer.byconsole@gmail.com', 'byconsole-woo-order-delivery-time') ).'</p><br />';
...
jQuery(document).ready(function(){
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="byconsolewooodt_current_website_url" id="form_url" readonly="readonly" value="<?php echo esc_url( get_site_url() );?>"/>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" name="byconsolewooodt_new_customer_email" id="form_mail" value="<?php echo esc_html( $admin_email );?>"/>
    ...
    <input type="submit" class="byconsolewooodt_new_customer_details_send" name="byconsolewooodt_new_customer_details_send" id="form_submit" value="<?php echo esc_html( __('Send', 'byconsole-woo-order-delivery-time') );?>">
