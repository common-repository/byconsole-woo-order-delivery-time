...
function byconsolewooodt_free_pickup_holiday_management(){
	...
	print_r($byconsolewooodt_pickup_holidays);
...
<input type="text" id="byconsolewooodt_free_delivery_pickup_holiday1" name="byconsolewooodt_free_delivery_pickup_holiday1" class="bycwooodt_admin_fields_design" readonly="readonly" value="<?php printf( esc_html(get_option('byconsolewooodt_free_delivery_pickup_holiday1')) ); ?>"><span class="calendar_opentext">Click On Text Box To Open Calendar </span> 
...
<input type="text" id="byconsolewooodt_free_delivery_pickup_holiday2" name="byconsolewooodt_free_delivery_pickup_holiday2" class="bycwooodt_admin_fields_design" readonly="readonly" value="<?php printf(esc_html( get_option('byconsolewooodt_free_delivery_pickup_holiday2') )); ?>"><span class="calendar_opentext">Click On Text Box To Open Calendar </span> 
