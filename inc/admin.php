...
$byconsolewooodt_admin_language_translator_settings=add_menu_page( 'ODT Management','ODT Management', 'manage_options', 'byconsolewooodt_order_pickup_delivery_settings_page', 'byconsolewooodt_admin_order_pickup_delivery_settings_form',plugin_dir_url( __FILE__ ) . '../images/bycwooodt_admin_menu_icon.png');


/*$byconsolewooodt_admin_settings = add_submenu_page('byconsolewooodt_general_settings', 'ByConsole Order Delivery Time', 'Delivery Pickup Management', 'manage_options', 'byconsolewooodt_general_settings', 'byconsolewooodt_admin_general_settings_form' );
...
$byconsolewooodt_admin_language_translator_settings=add_submenu_page('byconsolewooodt_general_settings', 'ODT Setting','ODT Setting', 'manage_options', 'byconsolewooodt_language_translator_settings_settings_page', 'byconsolewooodt_admin_language_translator_settings_form');*/
...
include('byconsolwooodt_language_translator.php');
...
include('bycwooodt_order_pickup_delivery_details_settings.php');
...
?>
			...
			<h1>ByConsole Woocommerce Order Delivery Pickup Management Settings Panel</h1>
...
<p><?php echo esc_html( __('The pro version includes:','byconsole-woo-order-delivery-time') );?></p>
 ...
 <ol>
    ...
    <li><?php echo esc_html( __('Set multiple delivery/pickup locations as many as you wish.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Time slot fee – add extra fees for delivery on special time slots.') );?></li>

    <li><?php echo esc_html( __('Set shop closing days based on week/week-end days like (every Sunday/Monday/../..)','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Set unlimited holidays (In free version its limites to two only).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Delivery/pickup date & time is now visible on WooCommerce orders page in admin dashboard for each order summery row.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Create time slot with any custom duration.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('You can customize date picker calendar according to your theme.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Minimum lead time / wait time.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Order placing cutoff time for sameday & nextday delivery & pickup <a class="byconsolebloglink" href=" separatelyhttps://blog.byconsole.com/same-day-delivery-cut-off-time-in-woocommerce/" target="_blank">Show me how!</a>.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Freedom to decide on which days to allow deliveries & pickups separately.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Option add extra fees for delivery on specific week days.','byconsole-woo-order-delivery-time') );?></li>

	<li><?php echo esc_html( __('Different delivery times for each delivery location (from v-1.0.3.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __(' Special dates open with additional fees <a class="byconsolebloglink" href="https://blog.byconsole.com/special-date-charges-in-woocommerce/" target="_blank">Show me how!</a>.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Set minimum order value for each pickup location and/or delivery area (from v-1.0.3.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Extra delivery charges for same day/next day/day after tomorrow delivery (from v-1.0.6.0 and with another addon).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Separated minimum waiting time for pickup and delivery.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Each delivery and pickup location can have separate email address to receive new order notification mail (from v-1.0.4.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Hide shipping fields when order type is pickup.','byconsole-woo-order-delivery-time') );?></li>

	<li><?php echo esc_html( __('Short code to list up all your delivery/pickup points(from v-1.0.5.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('override regular time slots on specia dates. <a class="byconsolebloglink" href="https://blog.byconsole.com/special-dates-with-special-time-slots/" target="_blank">Show me how!</a>.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Short code to display order date time location and type on any other pages/plugin(from v-1.0.5.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Lead time management for orders posted on store closing days(from v-1.0.6.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Option to limit number of pickups & deliveries separately per time slots <a class="byconsolebloglink" href="https://blog.byconsole.com/maximum-order-deliveries-per-time-slot/" target="_blank">Show me how!</a>.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Assign extra shipping charges per delivery areas / pickup hubs (from v-1.0.6.0).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Delivery on special calendar date with additioanl fees <a class="byconsolebloglink" href="https://blog.byconsole.com/special-date-charges-in-woocommerce/" target="_blank">Show me how!</a>.','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Product wise location based sale record and option export to CSV file (With our  another plugin).','byconsole-woo-order-delivery-time') );?></li>

	<li><?php echo esc_html( __('Get location on map and customer can pick a location directly from map(with map add-on plugin).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Suggest nearest pickup location by geo location calculation(with map add-on plugin).','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Remove chosen address fields from billing/shipping section of checkout page for pickup & delivery separately. <a class="byconsolebloglink" href="https://blog.byconsole.com/removing-billing-shipping-fields-on-woocommerce-checkout-page/" target="_blank">Show me how!</a>','byconsole-woo-order-delivery-time') );?></li>

    <li><?php echo esc_html( __('Get customized/more extended copy to suit your all needs(may be paid).','byconsole-woo-order-delivery-time') );?></li>
...
?>
 ...
 <input type="text" name="byconsolewooodt_chekout_page_section_heading" id="byconsolewooodt_chekout_page_section_heading" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_section_heading')) ); ?>"/>

 <label><?php echo esc_html( __('Texts to display on checkout page as section heading.','byconsole-woo-order-delivery-time') );?></label><br />
...
?>
 ...
 <input type="text" name="byconsolewooodt_chekout_page_date_label" id="byconsolewooodt_chekout_page_date_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_date_label')) ); ?>"/>

<label><?php echo esc_html( __('displayed as calendar label on checkout page.','byconsole-woo-order-delivery-time') );?></label><br />
...
?>
 ...
 <input type="text" name="byconsolewooodt_chekout_page_time_label" id="byconsolewooodt_chekout_page_time_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_time_label')) ); ?>"/>



 <label><?php echo esc_html( __('displayed as time drop-down label on checkout page.','byconsole-woo-order-delivery-time') );?></label><br />
...
?>
 ...
 <input type="text" name="byconsolewooodt_chekout_page_order_type_label" id="byconsolewooodt_chekout_page_order_type_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_order_type_label')) ); ?>"/>



 <label><?php echo esc_html( __('This will ask customer if the order is for delivery or self pickup on checkout page.','byconsole-woo-order-delivery-time') );?></label><br />
...
<?php
 ...
 <input type="text" name="byconsolewooodt_chekout_page_select_pickup_location_label" id="byconsolewooodt_chekout_page_select_pickup_location_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_select_pickup_location_label')) ); ?>"/>

 <label><?php echo esc_html( __('This will ask customer to choose a pickup location on checkout page, in case Multiple Pickup Location is enabled on Location Settings page','byconsole-woo-order-delivery-time') );?></label><br />
...
<input type="text" name="byconsolewooodt_chekout_page_hrs_value" id="byconsolewooodt_chekout_page_hrs_value" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_hrs_value')) ); ?>"/>	 <label><?php echo esc_html( __('Will be shown in time slot as time unit. ','byconsole-woo-order-delivery-time') );?></label><br />	 <span style="color:#a0a5aa">(Eg: Hrs)</span>	
...
<input type="text" name="byconsolewooodt_chekout_page_tips_label" id="byconsolewooodt_chekout_page_tips_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_tips_label')) ); ?>"/>	 <label><?php echo esc_html( __('This text will displayed on order summary table as extra fees paid for','byconsole-woo-order-delivery-time') );?></label><br />	 <span style="color:#a0a5aa">(Eg: Tips to delivery person)</span>	
...
?>	 <input type="text" name="byconsolewooodt_chekout_page_delivery_tip_label" id="byconsolewooodt_chekout_page_delivery_tip_label" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_chekout_page_delivery_tip_label')) ); ?>"/>	 <label><?php echo esc_html( __('This text will be displayed on order summary table, email & order details page as extra fees paid for','byconsole-woo-order-delivery-time') );?></label><br />	 <span style="color:#a0a5aa">(Eg: Tips to delivery person)</span>	
...
<label>
	...
	<input type="radio" name="byconsolewooodt_display_time_as" id="byconsolewooodt_display_time_as" value="time_slot" class="byconsolewooodt_admin_element_field radio" <?php if($byconsolewooodt_display_time_as_val == 'time_slot') {?> checked="checked" <?php }?>  />&nbsp; <?php echo esc_html( __('Time Slot','byconsole-woo-order-delivery-time') );?></label>

<label>

    <input type="radio" name="byconsolewooodt_display_time_as" id="byconsolewooodt_display_time_as" value="fixed_time" class="byconsolewooodt_admin_element_field radio" <?php if($byconsolewooodt_display_time_as_val == 'fixed_time') {?> checked="checked" <?php }?>  />&nbsp; <?php echo esc_html( __('Fixed Time','byconsole-woo-order-delivery-time') );?></label><br />

    <span style="color:#a0a5aa; line-height:50px !important;"><?php echo esc_html( __('NB: Time Slot will always be displayed as in 24 hours format.') );?></span><br />
...
?>
 ...
 <label><?php echo esc_html( __('24 hours or 12 hours with AM / PM.','byconsole-woo-order-delivery-time') );?> </label>
...
<input type="number" name="byconsolewooodt_preorder_days" id="byconsolewooodt_preorder_days" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_preorder_days')) ); ?>"/>

<label><?php echo esc_html( __('Leave blank to not set and pre-order days, this is number of days customer can pre order in advance.','byconsole-woo-order-delivery-time') );?></label><br />
...
<?php
	...
	function byconsolewooodt_time_field_validation(){
		...
		?>
			...
			<input type="checkbox" name="byconsolewooodt_time_field_validation" class="byconsolewooodt_admin_element_field checkbox" id="byconsolewooodt_time_field_validation" value="yes" <?php echo esc_html($checked);?>/>

            <label><?php echo esc_html( __('Make time selection mendatory.','byconsole-woo-order-delivery-time') );?></label>
...
?>	
	...
	<input type="checkbox" name="add_delivery_pickup_date_time_in_order_note" id="add_delivery_pickup_date_time_in_order_note" class="byconsolewooodt_admin_element_field checkbox" value="yes" <?php if($add_delivery_pickup_date_time_in_order_note == 'yes') { ?>  checked <?php } ?> /><label><?php echo esc_html( __('If checked then it will add delivery/pickup date time in order note. Useful for third party apps those access order data by WooCommerce REST API','byconsole-woo-order-delivery-time') );?></label>
...
<?php
	...
	function byconsolewooodt_time_field_show(){
		...
		?>
			...
			<input type="checkbox" name="byconsolewooodt_time_field_show" class="byconsolewooodt_admin_element_field checkbox" id="byconsolewooodt_time_field_show" value="yes" <?php echo esc_html( $checked );?>/>

            <label><?php echo esc_html( __('Ask for delivery/pickup time.','byconsole-woo-order-delivery-time') );?></label>
...
?>	
	...
	<input type="checkbox" name="byconsolewooodt_tips_show_on_checkout_page" id="byconsolewooodt_tips_show_on_checkout_page" class="byconsolewooodt_admin_element_field checkbox" value="yes" <?php if($byconsolewooodt_tips_show_on_checkout_page == 'yes') { ?>  checked <?php } ?> /><label><?php echo esc_html( __('If checked then it will optionally ask for "Tips for delivery person" on checkout page.','byconsole-woo-order-delivery-time') );?></label>
...
<label><?php echo esc_html( __('From','byconsole-woo-order-delivery-time') );?></label>



<input type="time" name="byconsolewooodt_opening_hours_from" id="byconsolewooodt_opening_hours_from" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_opening_hours_from')) ); ?>" />



<label><?php echo esc_html( __('To','byconsole-woo-order-delivery-time') );?></label>



<input type="time" name="byconsolewooodt_opening_hours_to" id="byconsolewooodt_opening_hours_to" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_opening_hours_to')) ); ?>" />



<label><?php echo esc_html( __('Allowable Pickup Time.','byconsole-woo-order-delivery-time') );?></label>
...
<input type="time" name="byconsolewooodt_delivery_hours_from" id="byconsolewooodt_delivery_hours_from" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_delivery_hours_from')) ); ?>" />

<label><?php echo esc_html( __('To','byconsole-woo-order-delivery-time') );?></label>

<input type="time" name="byconsolewooodt_delivery_hours_to" id="byconsolewooodt_delivery_hours_to" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_delivery_hours_to')) ); ?>" />

<label><?php echo esc_html( __('Allowable Delivery Time.','byconsole-woo-order-delivery-time') );?></label>
...
<input type="text" name="byconsolewooodt_delivery_times" id="byconsolewooodt_delivery_times" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_delivery_times')) ); ?>" />

<label> <?php echo esc_html( __('This is visible on widget front end if customer has chosen delivery.','byconsole-woo-order-delivery-time') );?></label><br />
...
<input type="text" name="byconsolewooodt_takeaway_lable" id="byconsolewooodt_takeaway_lable" style="width:50%; padding:7px;" value="<?php echo esc_html(get_option('byconsolewooodt_takeaway_lable')); ?>" />

<label> <?php echo esc_html( __('Take away label shown on checkout page and in widget.') );?></label><br />
...
<input type="text" name="byconsolewooodt_delivery_lable" id="byconsolewooodt_delivery_lable" style="width:50%; padding:7px;" value="<?php echo esc_html(get_option('byconsolewooodt_delivery_lable')); ?>" />

<label> <?php echo esc_html( __('Delivery label shown on checkout page and in widget.') );?></label><br />
...
<input type="text" name="byconsolewooodt_date_field_text" id="byconsolewooodt_date_field_text" style="width:50%; padding:7px;" value="<?php echo esc_html(get_option('byconsolewooodt_date_field_text')); ?>" />

<label> <?php echo esc_html( __('Placeholder text for date-picker calendar input box.') );?></label><br />
...
<input type="text" name="byconsolewooodt_time_field_text" id="byconsolewooodt_time_field_text" style="width:50%; padding:7px;" value="<?php echo esc_html(get_option('byconsolewooodt_time_field_text')); ?>" />

<label> <?php echo esc_html( __('Placeholder text for time drop-down input box.') );?></label><br />
...
<input type="text" name="byconsolewooodt_orders_delivered" id="byconsolewooodt_orders_delivered" style="width:50%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_orders_delivered')) ); ?>" />

<label> <?php echo esc_html( __('This is the text is shown on Order details page of customer side.','byconsole-woo-order-delivery-time') );?></label><br />

<span style="color:#a0a5aa">(<?php echo esc_html( __('Eg: The order will be delivered on','byconsole-woo-order-delivery-time') );?>  [byc_delivery_date] <?php echo esc_html( __('at','byconsole-woo-order-delivery-time') );?>   [byc_delivery_time])</span>
...
<input type="text" name="byconsolewooodt_orders_pick_up" id="byconsolewooodt_orders_pick_up" style="width:50%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_orders_pick_up')) ); ?>" />

<label> <?php echo esc_html( __('This is the text is shown on Order details page of customer side.','byconsole-woo-order-delivery-time') );?></label><br />

<span style="color:#a0a5aa">(<?php echo esc_html( __('Eg: The order can be Picked Up on','byconsole-woo-order-delivery-time') );?>  [byc_pickup_date] <?php echo esc_html( __('at','byconsole-woo-order-delivery-time') );?>  [byc_pickup_time])</span>
...
<?php
	...
	<input type="text" name="byconsolewooodt_select_tip_lable_text" id="byconsolewooodt_select_tip_lable_text" style="width:30%; padding:7px;" value="<?php printf( esc_html( __('%s','byconsole-woo-order-delivery-time'),get_option('byconsolewooodt_select_tip_lable_text')) ); ?>" />

	<label> <?php echo esc_html( __('Texts for "No tips" option, like "Not this time!"') );?></label><br />
...
<label><?php echo esc_html( __('Choose if tracking text have to be shown on top (before order product list) or bottom (after product list).','byconsole-woo-order-delivery-time') );?> </label>
